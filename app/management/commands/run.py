...
class Command(BaseCommand):
    ...
    def create_users(self):
        ...
        saved_users = User.objects.order_by('-id')[:self.count]

        profiles = [
            Profile(user=user, avatar=f'uploads/avatar{r.randint(1, 8)}.jpg')
    ...
    def create_questions(self):
        ...
        saved_questions = Question.objects.order_by('-id')[:len(questions)]
